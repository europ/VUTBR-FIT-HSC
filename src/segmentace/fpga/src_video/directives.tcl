...
go architect
directive set /video_buf/core/if#2:write_mem(buffer:rsc.@) -IGNORE_DEPENDENCY_FROM read_mem(buffer:rsc.@)
directive set /video_buf/core/read_mem(buffer:rsc.@) -IGNORE_DEPENDENCY_FROM if#2:write_mem(buffer:rsc.@)
go extract
